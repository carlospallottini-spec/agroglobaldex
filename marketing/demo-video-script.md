# AgroGlobalDex — Demo Video Script (90 segundos)

> Para grabar con OBS + screen recording de la web local. Voice-over en español
> con subtítulos EN. Output target: 1080p, 90s, formato cuadrado 1:1 para
> LinkedIn + horizontal 16:9 para YouTube.
>
> Estructura: HOOK (10s) → PROBLEM (15s) → SOLUTION (40s) → PROOF (15s) → CTA (10s).
...
## 0:25–1:05 — Solution (screen recording de la web)

**Sub-segmento A (0:25-0:40):** Mostrar `/marketplace` con activos listados.
...
**Sub-segmento B (0:40-0:55):** Mostrar `/tokenize` wizard 4 pasos.
...
**Sub-segmento C (0:55-1:05):** Mostrar `/invest` con yield offerings.

> "Un inversor en Madrid puede comprar 1 kilo de carne argentina o
> 10 litros de vino chileno desde la misma app, con compliance MiCA
> verificada on-chain."
...
> "Está construido. 17 instrucciones en Solana, dos programas Anchor,
...
**On-screen text:** "17 instructions on-chain. 0 audited yet. Open source."

---

## 1:20–1:30 — CTA (cámara al founder)

> "Estamos levantando 500 mil dólares para llevarlo a mainnet con audit y
> compliance MiCA. Si esto te interesa, escríbeme."
...
- **Master 90s 16:9** — YouTube, embed en web, demo days.
- **Cuadrado 1:1 90s** — LinkedIn feed.
- **Vertical 9:16 60s** — TikTok / Instagram Reels (cortar a sub-segmentos B + C + CTA).
- **GIF 6s loop** — Twitter cover / DM teaser (sólo el flow de tokenizar).
